...
\newcommand{\putabstract}{ Musical performances with touch-screen
  ...
  of improvised performances, and the potential for re-synthesis into
...
\institute{Charles Martin \at Research School of Computer Science, The
  ...
  University, Canberra, Australia \email{henry.gardner@anu.edu.au}}
...
While western classical music is often defined by the
...
\begin{figure}
\begin{center}
\includegraphics[width=0.7\columnwidth]{syntaxofsnow-excerpt-bw}
\end{center}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{ensemblemetatone-bw}
...
\begin{figure}
\begin{center}
  \includegraphics[width=0.45\textwidth]{app-2-MetaLonsdale-bw}
  \includegraphics[width=0.45\textwidth]{app-3-BirdsNest-bw}
  \includegraphics[width=0.45\textwidth]{app-4-SnowMusic-bw}
  \includegraphics[width=0.45\textwidth]{app-5-PhaseRings-bw}
\end{center}
...
\begin{figure}
\centering
\includegraphics[width=0.85\textheight,angle=90,origin=c]{Performance-14-08-14-18_40-bw.pdf}
\includegraphics[width=0.85\textheight,angle=90,origin=c]{gesture-score-15-05-07-18-52-bw.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{metatone-visualisation-metalonsdale-bw}
  \includegraphics[width=0.9\textwidth]{metatone-visualisation-youarehere-bw}
  \includegraphics[width=0.9\textwidth]{metatone-visualisation-touchandtone-bw}
...
\bibliography{preserving-bibliography}
\end{document}
